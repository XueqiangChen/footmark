 ...
 * It is annotated with @JsonIgnoreProperties from the Jackson JSON processing
 * library to indicate that any properties not bound in this type should be ignored.
 *
 * To directly bind your data to your custom types, you need to specify the variable
 * name to be exactly the same as the key in the JSON document returned from the API.
